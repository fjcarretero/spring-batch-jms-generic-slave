 ...
 * 
 */
public class MyRemoteChunkHandlerFactoryBean<T> implements FactoryBean<ChunkProcessor<T>> {

	private static Log logger = LogFactory.getLog(MyRemoteChunkHandlerFactoryBean.class);
