 ...
 */
public class SerializableChunkProcessor<I, O> implements ChunkProcessor<I>,
	...
	public SerializableChunkProcessor(
	...
	private void validate() {
		...
		Assert.isInstanceOf(Serializable.class, itemProcessor,
				"itemProcessor must implement Serializable");
		Assert.isInstanceOf(Serializable.class, itemWriter,
				"itemWriter must implement Serializable");
