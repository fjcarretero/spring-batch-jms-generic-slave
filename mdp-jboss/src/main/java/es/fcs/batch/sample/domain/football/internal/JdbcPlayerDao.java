...
package es.fcs.batch.sample.domain.football.internal;
...
import es.fcs.jdbc.core.simple.SimpleJdbcDaoSupport;
...
public class JdbcPlayerDao extends SimpleJdbcDaoSupport implements PlayerDao, Serializable  {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -5883228820106013605L;
