...
CREATE TABLE CUSTOMER_SEQ (ID BIGINT NOT NULL) engine=MYISAM;
INSERT INTO CUSTOMER_SEQ values(0);
CREATE TABLE BATCH_STAGING_SEQ (ID BIGINT NOT NULL) engine=MYISAM;
INSERT INTO BATCH_STAGING_SEQ values(0);
CREATE TABLE TRADE_SEQ (ID BIGINT NOT NULL) engine=MYISAM;
